...
public class MainActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // displayScreen(R.id.nav_planner);      this method will set planner as the first activity to be opened
    }
    ...
    private void displayScreen(int id){
        ...
        switch(id){
            ...
            case R.id.nav_add_task:
                ...
                break;
            case R.id.nav_course_edit:
                fragment = new CourseEdit();
                break;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_course_edit) {
